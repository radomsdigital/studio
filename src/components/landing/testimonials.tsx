...
const testimonials: Testimonial[] = [
  {
    ...
    quote: 'LIEYWOK made it incredibly easy to find a reliable plumber on short notice. The booking process was simple and the service was top-notch!',
    authorName: 'Jane Doe',
  ...
  },
  {
    ...
    quote: 'As a service provider, LIEYWOK has connected me with so many new clients. The platform is user-friendly and has been great for my business.',
  ...
  },
  {
    ...
    quote: 'I needed a last-minute caterer for an event, and LIEYWOK came to the rescue. The quality of service exceeded my expectations.',
